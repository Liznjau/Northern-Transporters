...
<title>Admin Login | Northern Travellers</title>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
         <ul class="nav navbar-nav navbar-right">
           ...
           <li><a href="admin-login.php" class="smoothScroll"><span class="highlight">ADMIN</span></a></li>
         </ul>
       </div>
      </div>
    </div>
    ...
    <section id="login-banner">
      <div class="container">
        <ol class="breadcrumb" id="breadcrumb">
           ...
           <li class="highlight">Admin Login</li>
        </ol>
           <div class="signup-section">
     	   		<div class="col-md-12 col-sm-12 col-xs-12" >
               <div class="details-section">
                 <div class="details-header">ADMIN LOGIN</div>
                 <div class="details-form">
                   <form action="" method="post">
                       ...
                       <input name="admin-login" value="LOGIN" class="btn-default btn-submit" type="submit">
                     </form>
                 </div>
               </div>
             </div>
